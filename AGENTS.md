...
This repository is the Zed extension for Crossplane YAML powered by `vibe-xpls`.

- Keep the extension id and language server id as `crossplane-yaml`; do not change them back to earlier extension identities.
...
- Zed manual validation should install this repository as a dev extension, not an earlier extension.
